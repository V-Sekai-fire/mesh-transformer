...
# +
dataset = MeshDataset.load("./mesh-transformer-datasets/objverse_250f_45.9M_3086_labels_53730_10_min_x1_aug.npz")  
dataset2 = MeshDataset.load("./mesh-transformer-datasets/objverse_250f_229.7M_3086_labels_268650_10_min_x5_aug.npz")
...
torch.save(pkg, f"./16k_autoencoder.pt")
